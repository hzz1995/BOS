...
public class MailUtils {
	...
	private static String password = "a1008611";
	private static String from = "15273386856@163.com";
	...
	public static void main(String[] args) {
		sendMail("测试邮件", "你好，传智播客", "15273386856@163.com");
	}
}
